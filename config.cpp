class CfgPatches
{
    class ld3k_gm6_lynx_127x99_compat_ace3
    {
        ...
        units[]=
        {
            ...
            "Item_ld3k_gm6_optic_AMS_Night_Vision",
            "Item_ld3k_gm6_optic_AMS_Night_Vision_khk",
            "Item_ld3k_gm6_optic_AMS_Night_Vision_snd",
            "Item_ld3k_gm6_optic_KHS_Night_Vision_blk",
            "Item_ld3k_gm6_optic_KHS_Night_Vision_hex",
            "Item_ld3k_gm6_optic_KHS_old_Night_Vision",
            "Item_ld3k_gm6_optic_KHS_Night_Vision_tan"
        };
        weapons[]=
        {
            ...
            "ld3k_gm6_optic_AMS_Night_Vision",
            "ld3k_gm6_optic_AMS_Night_Vision_khk",
            "ld3k_gm6_optic_AMS_Night_Vision_snd",
            "ld3k_gm6_optic_KHS_Night_Vision_blk",
            "ld3k_gm6_optic_KHS_Night_Vision_hex",
            "ld3k_gm6_optic_KHS_old_Night_Vision",
            "ld3k_gm6_optic_KHS_Night_Vision_tan"
        };
    };
};
class SlotInfo;
...
class asdg_OpticRail1913: asdg_OpticRail
{
    class compatibleItems
    {
        ...
        ld3k_gm6_optic_AMS_Night_Vision=1;
        ld3k_gm6_optic_AMS_Night_Vision_khk=1;
        ld3k_gm6_optic_AMS_Night_Vision_snd=1;
        ld3k_gm6_optic_KHS_Night_Vision_blk=1;
        ld3k_gm6_optic_KHS_Night_Vision_hex=1;
        ld3k_gm6_optic_KHS_old_Night_Vision=1;
        ld3k_gm6_optic_KHS_Night_Vision_tan=1;
    };
};
...
class CfgAmmo
{
    ...
    class ld3k_B_127x99_Ball_M33: BulletBase // Barrett 661gr M33 Ball https://barrett.net/products/accessories/ammunition/50bmg/
    {
        ...
        ACE_barrelLengths[]={508,736.6,812.8,914.4,1143}; // 20, 29, 32, 36, 45", 836m/s barrel length 730mm, https://barrett.net/products/accessories/ammunition/50-bmg-archive/
        ...
        cost=5;
        airLock=1;
        caliber=2.6; // 12.7x99mm AP perforation 22mm 700m ~560m/s (https://www.nammo.com/), SD 0.362 lb/in2, should be 4mm Steel plate 1200m, effective perforation in-game 5mm RHA "armour_plate_5mm.bisurf" 1200m ~370m/s: caliber ~0.9
        ...
        airFriction=-0.00065897; // airFrictionAnalysis.txt in docs folder
        class CamShakeExplode
        {
            power=3.60555;
            duration=0.8;
    ...
    class ld3k_B_127x99_Ball_AMAX: ld3k_B_127x99_Ball_M33 // https://www.hornady.com/ammunition/rifle/50-bmg-750-gr-a-max-match#!/
    {
        ...
        ACE_muzzleVelocities[]={751,826,840,858,889}; // 2463, 2709, 2757, 2815, 2917fps, 824m/s barrel length 730mm
        ...
        airFriction=-0.000396; // airFrictionAnalysis.txt in docs folder
    };
    ...
    { // Very high M903 SLAP BC 1.101 with data below, change for M962 SLAP-T BC 0.735 more coherent with .30" projectile and 29" barrel muzzle velocity.
        ...
        ACE_muzzleVelocities[]={1029,1132,1152,1177,1219}; // 3377, 3715, 3781, 3860, 4000fps (1219m/s) 45", 1129m/s barrel length 730mm
        ...
        airFriction=-0.00051632; // airFrictionAnalysis.txt in docs folder
        cost=15;
        class CamShakeExplode
        {
            power=4.47214;
    ...
    class ld3k_B_127x99_Ball_Mk211_HEIAP: ld3k_B_127x99_Ball_M903_SLAP // Raufoss Mk 211 https://en.wikipedia.org/wiki/Raufoss_Mk_211, Nammo Multipurpose NM140 (Handbook 2018)
    {
        ...
        ACE_muzzleVelocities[]={752,828,842,860,891}; // 2468, 2715, 2763, 2821, 2923fps, 826m/s barrel length 730mm
        ...
        // caliber=3.4; // ??? Penetration requirement 22mm RHA 0° 200m, perforation 10.6mm steel 321–375 HB 30° 1000m (https://www.nammo.com/), effective perforation in-game 23mm RHA "armour_plate_23mm.bisurf" 200m ~735m/s: caliber ~2, effective perforation in-game 12mm RHA "armour_plate_12mm.bisurf" 1000m ~430m/s: caliber ~1.9
        typicalSpeed=891;
        airFriction=-0.00062968; // airFrictionAnalysis.txt in docs folder
    ...
    class ld3k_B_127x99_Ball_M8_API: ld3k_B_127x99_Ball_M903_SLAP
    {
        ...
        ACE_muzzleVelocities[]={764,841,856,874,905}; // 2508, 2758, 2807, 2866, 2970fps, 839m/s barrel length 730mm
        ace_vehicle_damage_incendiary=1;
        ...
        typicalSpeed=905;
        airFriction=-0.00070387; // airFrictionAnalysis.txt in docs folder
...
{
    class CA_Magazine;
    /*class 5Rnd_Mag: CA_Magazine // official BI tool All-in-one Config Arma3 2.19.152606 https://community.bistudio.com/wiki/Arma:_All-in-one_Config
    {
        author="$STR_A3_Bohemia_Interactive";
        scope=2;
        displayName="$STR_A3_CfgMagazines_5Rnd_Mag0";
        picture="\A3\Weapons_F_EPA\Data\ui\M_5rnd_ball_CA.paa";
        count=5;
        ammo="B_Ball";
        initSpeed=820;
        descriptionShort="$STR_A3_CfgMagazines_5Rnd_Mag1";
        mass=16;
    };*/
...
{
    /*class GM6 // official BI tool All-in-one Config Arma3 2.19.152606 https://community.bistudio.com/wiki/Arma:_All-in-one_Config
    {
        BI_Magazines[]=
        {
            "5Rnd_Mag",
    ...
    class GM6_127x99
    {
        ld3k_Magazines[]= // Weapon initSpeed -1 with GM6 Lynx ACE_barrelLength 730mm (28.74"), 836, 824, 1129, 826, 839m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to GM6 Lynx 5Rnd_127x99 magazines initSpeed
        {
...
class CfgWeapons
{
    ...
    class ld3k_GM6_Lynx_127x99: srifle_GM6_F
    {
        ...
        maxZeroing=3200; // distance 12.7x99mm AMAX Mach 0.8 (272m/s) ICAO, GM6_base_F 2200
    ...
    class ld3k_gm6_optic_LRPS_Night_Vision: optic_LRPS // Nightforce NXS 5.5-22x56
    {
        ...
        class ItemInfo: ItemInfo
        {
            ...
            class OpticsModes: OpticsModes
            {
                class Snip: Snip
                {
                    ...
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200,2300,2400,2500,2600}; // 2600m max distance at max elevation 29 mRad M903/962 SLAP (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_LRPS 2
                    distanceZoomMin=100; // optic_LRPS 300
                    distanceZoomMax=2600; // optic_LRPS 2400
    ...
    class ld3k_gm6_optic_AMS_base_Night_Vision: optic_AMS_base // US Optics MR-10
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ACE_ScopeHeightAboveRail=3.8933;
        ACE_ScopeAdjust_Vertical[]={0,16}; // US Optics Operators Manual
        ACE_ScopeAdjust_Horizontal[]={-11,11};
        ACE_ScopeAdjust_VerticalIncrement=0.1;
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_AMS_base_Night_Vision";
        class ItemInfo: ItemInfo
        {
            mass=17.5; // US Optics 2014 Product Catalog, optic_AMS_base 14
            class OpticsModes: OpticsModes
            {
                class AMS: AMS
                {
                    opticsZoomMin=0.025; // optic_AMS_base
                    opticsZoomMax=0.075; // optic_AMS_base
                    opticsZoomInit=0.075; // optic_AMS_base
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000}; // 2000m max distance at max elevation 16 mRad M903/962 SLAP (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_AMS_base 2
                    distanceZoomMin=100; // optic_AMS_base 300
                    distanceZoomMax=2000;
                    discretefov[]={0.075,0.025}; // optic_AMS_base
                    modelOptics[]=
                    {
                        "\ld3k_gm6_lynx_127x99_compat_ace3\acc\ld3k_reticle_acco_ams_F",
                        "\ld3k_gm6_lynx_127x99_compat_ace3\acc\ld3k_reticle_acco_ams_z_F"
                    };
                    visionMode[]=
                    {
                        "Normal",
    ...
    class ld3k_gm6_optic_AMS_Night_Vision: ld3k_gm6_optic_AMS_base_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_AMS_Night_Vision";
        scope=2;
        scopeCurator=1;
        scopeArsenal=2;
        displayName="AMS Night Vision (Black)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_AMS_ca.paa";
        DLC="Mark";
    };
    class ld3k_gm6_optic_AMS_Night_Vision_khk: ld3k_gm6_optic_AMS_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_AMS_Night_Vision_khk";
        displayName="AMS Night Vision (Khaki)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_AMS_khk_ca.paa";
        model="\A3\Weapons_F_Mark\Acc\acco_ams_khk_F.p3d";
        DLC="Mark";
    };
    class ld3k_gm6_optic_AMS_Night_Vision_snd: ld3k_gm6_optic_AMS_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_AMS_Night_Vision_snd";
        displayName="AMS Night Vision (Sand)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_AMS_snd_ca.paa";
        model="\A3\Weapons_F_Mark\Acc\acco_ams_snd_F.p3d";
        DLC="Mark";
    };
    class ld3k_gm6_optic_KHS_base_Night_Vision: optic_KHS_base // KAHLES HELIA 2.4-12x56
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ACE_ScopeHeightAboveRail=4.30723;
        ACE_ScopeAdjust_Vertical[]={0,19}; // HELIA 2.4-12x56
        ACE_ScopeAdjust_Horizontal[]={-9,9};
        ACE_ScopeAdjust_VerticalIncrement=0.1;
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_KHS_base_Night_Vision";
        class ItemInfo: ItemInfo
        {
            mass=15; // HELIA 2.4-12x56 680g, optic_KHS_base 14
            class OpticsModes: OpticsModes
            {
                class KHS: KHS
                {
                    opticsZoomMin=0.0227; // optic_KHS_base
                    opticsZoomMax=0.0536; // optic_KHS_base
                    opticsZoomInit=0.0536; // optic_KHS_base
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200}; // 2200m max distance at max elevation 19 mRad M903/962 SLAP (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_KHS_base 2
                    distanceZoomMin=100; // optic_KHS_base 300
                    distanceZoomMax=2200; // optic_KHS_base 2000
                    discretefov[]={0.0536,0.0227}; // optic_KHS_base
                    modelOptics[]=
                    {
                        "\ld3k_gm6_lynx_127x99_compat_ace3\acc\ld3k_reticle_acco_khs_F",
                        "\ld3k_gm6_lynx_127x99_compat_ace3\acc\ld3k_reticle_acco_khs_z_F"
                    };
                    visionMode[]=
                    {
                        "Normal",
    ...
    class ld3k_gm6_optic_KHS_Night_Vision_blk: ld3k_gm6_optic_KHS_base_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_KHS_Night_Vision_blk";
        scope=2;
        scopeCurator=1;
        scopeArsenal=2;
        displayName="Kahlia Night Vision (Black)";
        DLC="Mark";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_KHS_blk_ca.paa";
    };
    class ld3k_gm6_optic_KHS_Night_Vision_hex: ld3k_gm6_optic_KHS_Night_Vision_blk
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_KHS_Night_Vision_hex";
        displayName="Kahlia Night Vision (Hex)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_KHS_hex_ca.paa";
        model="\A3\Weapons_F_Mark\Acc\acco_khs_hex_F.p3d";
        DLC="Mark";
    };
    class ld3k_gm6_optic_KHS_old_Night_Vision: optic_KHS_old // KAHLES HELIA 2.4-12x56
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ACE_ScopeHeightAboveRail=4.30723;
        ACE_ScopeAdjust_Vertical[]={0,19}; // HELIA 2.4-12x56
        ...
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_KHS_old_Night_Vision";
        displayName="Kahlia Night Vision (Old)";
        class ItemInfo: ItemInfo
        {
            mass=15; // HELIA 2.4-12x56 680g, optic_KHS_base 14
            class OpticsModes: OpticsModes
    ...
    class ld3k_gm6_optic_KHS_Night_Vision_tan: ld3k_gm6_optic_KHS_Night_Vision_blk
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_optic_KHS_Night_Vision_tan";
        displayName="Kahlia Night Vision (Tan)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_optic_KHS_tan_ca.paa";
        model="\A3\Weapons_F_Mark\Acc\acco_khs_tan_F.p3d";
        DLC="Mark";
    };
};
class CfgVehicles
{
    ...
    class Item_ld3k_gm6_optic_AMS_Night_Vision: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Black)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_AMS_Night_Vision
            {
                name="ld3k_gm6_optic_AMS_Night_Vision";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_AMS_Night_Vision_khk: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Khaki)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_AMS_Night_Vision_khk
            {
                name="ld3k_gm6_optic_AMS_Night_Vision_khk";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_AMS_Night_Vision_snd: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Sand)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_AMS_Night_Vision_snd
            {
                name="ld3k_gm6_optic_AMS_Night_Vision_snd";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_KHS_Night_Vision_blk: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Black)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_KHS_Night_Vision_blk
            {
                name="ld3k_gm6_optic_KHS_Night_Vision_blk";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_KHS_Night_Vision_hex: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Hex)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_KHS_Night_Vision_hex
            {
                name="ld3k_gm6_optic_KHS_Night_Vision_hex";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_KHS_old_Night_Vision: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Old)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_KHS_old_Night_Vision
            {
                name="ld3k_gm6_optic_KHS_old_Night_Vision";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_optic_KHS_Night_Vision_tan: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Tan)";
        ...
        class TransportItems
        {
            class ld3k_gm6_optic_KHS_Night_Vision_tan
            {
                name="ld3k_gm6_optic_KHS_Night_Vision_tan";
                count=1;
            };
        };
    };
