...
class CfgAmmo
{
    ...
    class ld3k_B_127x99_Ball_AMAX: ld3k_B_127x99_Ball_M33 // https://www.hornady.com/ammunition/rifle/50-bmg-750-gr-a-max-match#!/
    {
        ...
        hit=33; // 19208 Joules
        caliber=3; // 0.41 lb/in2, ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L685
        typicalSpeed=889;
    ...
    class ld3k_B_127x99_Ball_Mk211_HEIAP: ld3k_B_127x99_Ball_M903_SLAP // Raufoss Mk 211 https://en.wikipedia.org/wiki/Raufoss_Mk_211, Nammo Multipurpose NM140(Handbook 2018)
    {
        ...
        indirectHitRange=0.6; // B_20mm 1.2
...
class CfgMagazineWells
{
    ...
    class GM6_127x99
    {
        ld3k_Magazines[]= // Weapon initSpeed -1 with ACE_barrelLength 736.6mm (29"), 838, 826, 1132, 828, 841m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to 5Rnd_127x99 magazines initSpeed
        {
...
class CfgWeapons
{
    ...
    class ld3k_GM6_Lynx_127x99: srifle_GM6_F
    {
        ...
        initSpeed=-0.99755; // 836, 824, 1129, 826, 839m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), GM6_base_F 0
        magazines[]=
        {
            "ld3k_5Rnd_127x99_M33_Mag",
            "ld3k_5Rnd_127x99_M33_Mag_Tracer_Red",
